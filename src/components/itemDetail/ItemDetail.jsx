...
const ItemDetail = ({ item }) => {
  ...
  const { addToCart, cart, toggleFavorite, isInFavorites } = useCartContext()
                ...
                <div className='ui-pdp-container__col col-2' style={{ maxWidth: "352px" }}>
                  <div className='ui-pdp-container__top-wrapper mt-40'>
                    <div className='ui-pdp-header'>
                      ...
                      <div className='ui-pdp-header__title-container' style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                        <h1 className='ui-pdp-title' style={{ flex: 1 }}> {item.nombre} </h1>
                        <button
                          className="ui-pdp-header__favorite-button"
                          onClick={(e) => { e.preventDefault(); toggleFavorite(item); }}
                          type="button"
                        >
                          <svg
                            className="ui-pdp-header__favorite-icon"
                  ...
                  <div className='ui-pdp-price mt-16 ui-pdp-price--size-large'>
                    ...
                    <div className='ui-pdp-price__subtitles'>
                      <p className='ui-pdp-color--GREEN ui-pdp-family--REGULAR' style={{ fontSize: '14px' }}>
