...
const Footer = () => {
    ...
    return (
        <>
            <div className={`nav-footer-access ${isExpanded ? 'nav-footer-access-expanded' : ''}`}>
                <button id='nav-footer-access-switch' onClick={() => setIsExpanded(!isExpanded)}>Más información</button>
